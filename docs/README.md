...
- [`development/TIER_PREFERENCE_CLOSURE.md`](development/TIER_PREFERENCE_CLOSURE.md): the minimum sample criterion (N = 10 since 2026-09-15) and the Model Router's measured tier preference (§10.5); why `CONDITIONAL` autonomy is not built; review dispositions.
