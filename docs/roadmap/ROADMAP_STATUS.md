...
| V1 decision pack | V4 (§9.4); Phase 4 Governor; §10.7 | **In progress 2026-09-15.** Conditional Autonomy built; Budget Governor downgrade/degrade built (`authorized` / `downgraded` / `degraded` / `denied`). | `development/V1_DECISION_PACK_CLOSURE.md` |
