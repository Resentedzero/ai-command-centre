    ...
    properties: {
      ...
      action: {
        ...
        properties: {
          ...
          useArtifacts: { type: "array", items: { type: "string" } },
        },
        required: ["type", "intent", "capability", "input", "instruction", "useArtifacts"],
        additionalProperties: false,
      },
      ledgerNote: { type: "string" },
    },
...
export const WORK_RESULT_SCHEMA = {
  type: "object",
  properties: { summary: { type: "string" }, content: { type: "string" }, keyPoints: { type: "array", items: { type: "string" } } },
        ...
        case "think": {
          ...
          const spec: LlmInvocationSpec = {
            ...
            directive:
              ...
              `the full result as Markdown in "content", and "keyPoints".`,
